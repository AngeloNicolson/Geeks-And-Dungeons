        ...
        <Suspense fallback={<LoadingScreen />}>
          <Canvas shadows gl={{ alpha: false }} style={{ background: "black" }}>
            ...
            {showAnnotation && activeAnnotation === "about-me" && (
              ...
              >
                <p className={styles.annotationContents}>
                  ...
                  at this stage in my quest I am studying software development
                  ...
                  industry. If I do not know something then I don't let that
                  hold me back, I find solutions to problems and practice until
                  ...
                  confident that I can positively impact the tech industry and
                  the people around me. If you have any advice or guidance, I'd
            ...
            {showAnnotation && activeAnnotation === "my-interests" && (
              ...
              >
                ...
                <div>
                  ...
                  <p className={styles.annotationContents}>
                    Another inspiring realm that fascinates me is image
                    analysis, where machine learning algorithms can
                    revolutionize web development and 3D model design processes.
                    I dream of creating a system that optimizes and creates 3D
                    designs and assets for the gaming industry, empowering
                    artists to unleash their creativity on the finer details.
                  </p>
                </div>
                <div>
                  ...
                  <p className={styles.annotationContents}>
                    ...
                    aspirations. I am driven by a strong belief in morally
                    correct practices and building a community of like-minded
                    enthusiasts and collaborators. Embracing open-source
                    software and content is a vital part of my vision, as I
                    firmly believe that sharing knowledge with a roots in an
                    open-source mindset fuels innovation and progress.
                  </p>
                </div>
                <div>
                  ...
                  <p className={styles.annotationContents}>
                    ...
                    world for all. My journey as a tech enthusiast is fueled by
                    a deep desire to make a difference, one idea and project at
                    a time. I'm eager to explore new frontiers, push boundaries,
                    and above all, learn.
                  </p>
                </div>
              </Annotation>
            ...
            {showAnnotation && activeAnnotation === "about-the-project" && (
              ...
              >
                <p className={styles.annotationContents}>
                  DISCLAIMER: This 3D Hompage serves as a gateway and
                  intorduction to the real project, just while it is being
                  built.
                  <br />
                  <br />
                  Geeks and Dungeons is a passion project that aims to unite
                  geeks worldwide to share thoughts and resources. The goal is
                  to create a digital forum that fosters genuine connections
                  among geeks and celebrates their unique interests, and
                  passions.
                  <br />
                  <br />
                  The project incorporates security middleware built around the
                  Auth0 service, ensuring robust authorization and
                  authentication, allowing users to interact with confidence.
                  Leveraging my web development studies in React and PostgreSQL,
                  along with familiarity with full-stack software development, I
                  have built this website to securely store and display user
                  input.
                  <br />
                  <br />
                  ...
                  meaningful interactions with an equally unique visual
                  interface. One day this website will enable users to express
                  themselves through their profile and personality deck
                  (Upcoming feature).
                  <br />
                  <br />
                  Driven by a strong belief in open-source collaboration, this
                  project aims to keep all the code direct code written for
                  Geeks and dungeons as opensource and available to anyone,
                  (This doesnt extend to the libraries used as they have thier
                  own indevidual licensing).
                </p>
              </Annotation>
            )}
            {/* Lights */}
